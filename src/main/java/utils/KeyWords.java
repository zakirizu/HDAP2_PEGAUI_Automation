	...
	*/	
	/*public static  void clickElementWithVisibleText(String eleText) {
		...
		if(highLigtElement.equalsIgnoreCase("yes"))
		{
			...
			js.executeScript("arguments[0].setAttribute('style','background:yellow;border:2px solid red;')", eleText);
			driver.findElement(By.xpath("//td[normalize-space(text())='"+eleText+"']/a")).click();
